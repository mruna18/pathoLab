...
<thead><tr><th>S.N</th>
    ...
    <tbody>
    <!-- <img src='uploads/<?php echo $file_name; ?>' alt='Uploaded Image'> -->
    <?php 
...
$query = $db->query("SELECT * FROM `uploaded_prescription` ORDER BY uploaded_on DESC;");

if($query->num_rows > 0){
    while($row = $query->fetch_assoc()){
        $imageURL = 'uploads/'.$row["file_name"];
?>
    <img src="<?php echo $imageURL; ?>" alt="images" />
<?php }
}else{ ?>
