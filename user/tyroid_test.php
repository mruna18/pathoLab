...
<div class="container my-3 ">
  <div class="row" style="width: 100%; background-color: : #fbf7f7;">
   <div style=" width: 15%;">
      <img src="img/tyroid.png" alt="thyroid">
    </div>
  <div style=" width: 80%;">
   <h4> Tyroid</h4>
    <p>
    ...
    <hr>
   <strong> Thyroid blood tests include</strong><br>

TSH - Done to measure the TSH levels and check for hormonal imbalance<br>
T4 - Done to measure free T4 (FT4 or FTI) and rule out hypothyroidism and hyperthyroidism<br>
T3 - Done to confirm the diagnosis of hyperthyroidism and determine its severity<br>
...
<hr>
<strong>Thyroid imaging tests include</strong>
<br>
CT scan<br>
Ultrasound and<br>
...
<?php 
      ...
      while($row = mysqli_fetch_assoc($result)){
        ...
        <div class="card-body">
          ...
          <a href="high-risk-tyroid.php?tyroidid=' . $id .' " class="btn" style="background-color:#151c48; color:white; border-radius: 12px;">Book</a>
        </div>
      </div>';
