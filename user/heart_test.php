...
<div class="container my-3 ">
  <div class="row" style="width: 100%; background-color: : #fbf7f7;">
   <div style=" width: 15%;">
      <img src="img/heart.png" alt="n=heart">
    </div>
  <div style=" width: 80%;">
   <h4> Heart</h4>
    <p>
...
<?php 
      ...
      while($row = mysqli_fetch_assoc($result)){
        ...
        <div class="card-body">
          ...
          <a href="high-risk-blood.php?riskid=' . $id .' " class="btn" style="background-color:#151c48; color:white; border-radius: 12px;">Book</a>
