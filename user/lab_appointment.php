...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $is_available = true;
    if ($is_available) {
      $sql = "INSERT INTO `lab_appointment` (`username`,`email`, `test_name`, `fee`, `appointmentTime`,`appointmentDate`, `timestamp`) VALUES ('$username','$email', '$test_name', '$fee', '$appointmentTime', '$appointmentDate', current_timestamp());";
      ...
      if ($result) {
        ...
        header("Location: process_appointment.php"); 
        exit();
      } else {
  ...
  <?php 
   ...
   if($showDanger){
    ...
    <div class="container my-3">
        <div class="card">
            <div class="card-header" style="color:white; background-color:black;">
                Fill the details for Lab Appointments
            </div>      
        </div>
    </div>
    ...
    <fieldset class='col-md-12 container-fluid'  style="background-color: #f2f2f2; box-shadow: 10px 10px 5px grey;" >
      <!-- <legend>&nbsp; Login &nbsp;</legend> -->
      <br>
   <h4><b>Appointment for Lab Testing</b></h4>
   <hr>
<!-- /pathology/user/demo.php     process-->

 <form action="lab_appointment.php" method="post">
...
<div class="form-group">
    <label for="username"  style="font-size: 16px">Username:<strong> <?php echo $_SESSION['username']; ?></strong></label>
...
<div class="form-group">
    ...
    <small style="color:red;">Enter the correct email to recieve appointment confirmation and payment link mail!</small>
</div>
...
<div class="form-group">
             ...
             <option value="Complete Blood Count Test">Complete Blood Count Test</option>
...
<div class="form-group ">
 ...
 <input class="form-control "  type="date" name="appointmentDate" id="aptDate" min="2023-09-01" max="2023-12-31" aria-describedby="prefer_date" data-date-format="yyyy-mm-dd" required>
